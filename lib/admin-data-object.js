...
function get ({type, id, token, labMode = true}) {
  ...
  const url = `https://dictionary.produs1.ciscoccservice.com/dictionary/${type}/v1/status/${id}`
...
function search ({type, bearer, query = 'id:*', maxEntries = 1500}) {
  const url = `https://dictionary.produs1.ciscoccservice.com/dictionary/${type}/v1/search`
