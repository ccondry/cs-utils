...
/**
 * Removes illegal path characters from part of a path.
 *
 * @param pathPart The part of the path in between slashes.
 */
function fixPathPart(pathPart) {
