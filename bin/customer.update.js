...
if(argv.help ){
	console.log(chalk.yellow("Usage: cs-customer-update --token --id [--discovery] [--prod] [--fieldset] [--field] [--help]"));
	return;
}
if(!argv.token ){
	console.log(chalk.red("Please provide token"));
	console.log(chalk.yellow("Usage: cs-customer-update --token --id [--discovery] [--fieldset] [--field] [--help]"));
	return;
}
if(!argv.id ){
